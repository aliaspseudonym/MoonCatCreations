...
function twentythirteen_header_style() {
	...
	?>
		.site-header {
			background: url(<?php header_image(); ?>) no-repeat scroll center top;
...
function twentythirteen_admin_header_image() {
	...
	?>
	<div id="headimg" style="background: url(<?php echo esc_url( get_header_image() ); ?>) no-repeat scroll top; background-size: 1800px auto;">
		<div class="home-link">
